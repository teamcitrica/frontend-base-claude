  ...
  return (
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <Card className="p-6">
          <div className="text-center py-8">
            <Icon className="mx-auto text-gray-400 mb-4" name="AlertCircle" size={48} />
            ...
            <div className="flex items-center gap-4">
              <div className="flex-shrink-0">
                <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center">
                  <Icon color="#2563eb" className="text-blue-600" name="Calendar" size={24} />
                </div>
              </div>
            ...
            <div className="flex items-center gap-4">
              <div className="flex-shrink-0">
                <div className="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center">
                  <Icon color="purple" name="Clock" size={24} />
                </div>
              </div>
              <div className="flex-1">
                <Text isAdmin={true} textColor="color-admin-on-surface" variant="title">
